...
public class StudentController {
    ...
    public ResultObject<List<UserVo>> getUsers(TStudent student,@RequestParam("limit") int limit,@RequestParam("page") int page) {
    	PageInfo<UserVo> pageInfo=studentService.getAll(student, page, limit);
    	ResultObject<List<UserVo>> rs= new ResultObject<> ();
    ...
    public ResultObject<Object> update(@RequestParam("id") int id,@RequestParam("num")int num) {
	    Integer total=studentService.updateStudent(id,num);
	    //统一返回
    	ResultObject<Object> rs=new ResultObject<Object>();
