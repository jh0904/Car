...
public class ScoreController {
    ...
    public ResultObject<List<Park>> getAllScore(TScore score,@RequestParam("limit") int limit,@RequestParam("page") int page) {
    	PageInfo<Park> pageInfo=scoreService.getAllPark (score,limit, page);
    	ResultObject<List<Park>> rs=new ResultObject<List<Park>>();
